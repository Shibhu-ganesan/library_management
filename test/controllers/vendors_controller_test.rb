...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference('Vendor.count') do
      post vendors_url, params: { vendor: { vendor_mail: @vendor.vendor_mail, vendor_name: @vendor.vendor_name } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { vendor_mail: @vendor.vendor_mail, vendor_name: @vendor.vendor_name } }
